...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, Object> consumerFactory() {
        ...
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "br.com.vortex.desafio.backend.dto");
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "br.com.vortex.desafio.backend.dto.KafkaEventDTO");
