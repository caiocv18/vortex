...
public class KafkaConfig {
    ...
    @Value("${spring.kafka.consumer.group-id:nexdom-inventory-group}")
    ...
    public NewTopic movimentoEstoqueTopic() {
        return TopicBuilder.name("nexdom.movimento.estoque")
                .partitions(3)
                .replicas(1)
    ...
    public NewTopic produtoEventsTopic() {
        return TopicBuilder.name("nexdom.produto.events")
                .partitions(2)
                .replicas(1)
    ...
    public NewTopic alertasEstoqueTopic() {
        return TopicBuilder.name("nexdom.alertas.estoque")
                .partitions(1)
                .replicas(1)
    ...
    public NewTopic relatoriosEventsTopic() {
        return TopicBuilder.name("nexdom.relatorios.events")
                .partitions(1)
                .replicas(1)
    ...
    public NewTopic auditoriaTopic() {
        return TopicBuilder.name("nexdom.auditoria")
                .partitions(2)
                .replicas(1)
    ...
    public ConsumerFactory<String, Object> consumerFactory() {
        ...
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "br.com.nexdom.desafio.backend.dto");
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "br.com.nexdom.desafio.backend.dto.KafkaEventDTO");
