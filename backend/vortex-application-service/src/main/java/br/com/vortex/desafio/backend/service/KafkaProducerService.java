...
public class KafkaProducerService implements MessageBrokerService {
    ...
    @Value("${kafka.topics.movimento-estoque:vortex.movimento.estoque}")
    private String movimentoEstoqueTopic;

    @Value("${kafka.topics.produto-events:vortex.produto.events}")
    private String produtoEventsTopic;

    @Value("${kafka.topics.alertas-estoque:vortex.alertas.estoque}")
    private String alertasEstoqueTopic;

    @Value("${kafka.topics.relatorios-events:vortex.relatorios.events}")
    private String relatoriosEventsTopic;

    @Value("${kafka.topics.auditoria:vortex.auditoria}")
